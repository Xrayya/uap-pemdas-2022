public class Domba extends Hewan {
    ...
    public double dailySell() {
        // Code here
        return this.getQuantity() * this.getWoolInKgPerDay() * this.getWoolPrice();
    }
    ...
    public String toString() {
        ...
        output += String.format("Wool/hari\t: %f kg(per ekor)\n", this.getWoolInKgPerDay());
        output += String.format("Harga wool\t: %s (per kg)\n", Helper.getFormattedPrice(this.getWoolPrice()));
