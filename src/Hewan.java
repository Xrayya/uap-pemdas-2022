public abstract class Hewan implements BuyableInterface {
    ...
    public double getTotalExpense() {
        // Code in here
        return this.getQuantity() * this.getExpensePerDay();
    }
    ...
    public String toString() {
        ...
        output += String.format("Jumlah\t\t: %d ekor\n", this.getQuantity());
        output += String.format("Pengeluaran\t: %s (per hari)\n", Helper.getFormattedPrice(this.getTotalExpense()));
        return output;
    }
