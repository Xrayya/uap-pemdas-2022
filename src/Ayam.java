public class Ayam extends Hewan implements TreatmentInterface {
    ...
    public double dailySell() {
        // Code here
        return this.getQuantity() * this.getEggPerDay() * this.getEggPrice();
    }
    ...
    public String toString() {
        ...
        output += String.format("Telur/hari\t: %d butir (per ekor)\n", this.getEggPerDay());
        output += String.format("Harga telur\t: %s (per butir)\n", Helper.getFormattedPrice(this.getEggPrice()));
